---
title: "Control_Wells_weekly_avgs_July2021"
author: "Simon Marks"
date: "7/21/2021"
...
Control_Wells_July2021 <- readr::read_csv("Control_Wells_July2021/raw/compiledwells_Control_July2021.csv", 
...
Control_Wells_good_data_July2021 <- Control_Wells_July2021 %>%
...
weekly_Control_Wells_toJuly2021 <- temp_agg_meadow_dat(Control_Wells_good_data_July2021, interval = "30 min", start_day_of_week = 6) %>% 
  mutate(date = as.character(date)) %>%
  dplyr::rename(Date = date) %>%
...
weekly_Control_Wells_toJuly2021 %>% 
  readr::write_csv(path = "Control_Wells_July2021/weekly_Wells_Control_July2021.csv")
