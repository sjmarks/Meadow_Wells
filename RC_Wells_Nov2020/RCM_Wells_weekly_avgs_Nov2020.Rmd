---
title: "RCM_Wells_weekly_avgs_Nov2020"
author: "Simon Marks"
date: "12/7/2020"
...
## Latest RCM Well Compilation Data (Nov 2020)

```{r}

RC_Wells_Nov2020 <- readr::read_csv("RC_Wells_Nov2020/raw/compiledwells_RC_Nov2020.csv", 
...
weekly_RC_Wells_toNov2020 <- temp_agg_meadow_dat(RC_Wells_good_data_Nov2020, interval = "30 min", start_day_of_week = 7) %>% 
  mutate(date = as.character(date)) %>%
  rename(Date = date) %>%
...
weekly_RC_Wells_toNov2020 %>% 
  readr::write_csv(path = "RC_Wells_Nov2020/weekly_Wells_RC_Nov2020.csv")
