---
title: "RCM_Wells_weekly_avgs_July2021"
author: "Joe Murphy"
date: "08/19/2021"
...
## Latest RCM Well Compilation Data (July 2021)

```{r}

RC_Wells_July2021 <- readr::read_csv("raw/compiledwells_RC_July2021.csv", 
...
RC_Wells_good_data_July2021 <- RC_Wells_July2021 %>%
...
weekly_RC_Wells_toJuly2021 <- temp_agg_meadow_dat(RC_Wells_good_data_July2021, interval = "30 min", start_day_of_week = 7) %>% 
  mutate(date = as.character(date)) %>%
  rename(Date = date) %>%
...
weekly_RC_Wells_toJuly2021 %>% 
  readr::write_csv(path = "weekly_Wells_RC_July2021.csv")
