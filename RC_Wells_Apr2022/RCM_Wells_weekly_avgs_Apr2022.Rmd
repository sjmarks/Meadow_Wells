---
title: "RCM_Wells_weekly_avgs_Apr2022"
author: "Joe Murphy"
date: "05/04/2022"
...
## Latest RCM Well Compilation Data (April 2022)

```{r}

RC_Wells_Apr2022 <- readr::read_csv("raw/compiledwells_RC_Apr2022.csv", 
...
RC_Wells_good_data_Apr2022 <- RC_Wells_Apr2022 %>%
...
weekly_RC_Wells_toApr2022 <- temp_agg_meadow_dat(RC_Wells_good_data_Apr2022, interval = "30 min", start_day_of_week = 7) %>% 
  mutate(date = as.character(date)) %>%
  rename(Date = date) %>%
...
weekly_RC_Wells_toApr2022 %>% 
  readr::write_csv(path = "weekly_Wells_RC_Apr2022.csv")
