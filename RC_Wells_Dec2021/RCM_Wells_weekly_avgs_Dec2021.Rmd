---
title: "RCM_Wells_weekly_avgs_Dec2021"
author: "Joe Murphy"
date: "02/04/2022"
...
## Latest RCM Well Compilation Data (December 2021)

```{r}

RC_Wells_Dec2021 <- readr::read_csv("raw/compiledwells_RC_Dec2021.csv", 
...
RC_Wells_good_data_Dec2021 <- RC_Wells_Dec2021 %>%
...
weekly_RC_Wells_toDec2021 <- temp_agg_meadow_dat(RC_Wells_good_data_Dec2021, interval = "30 min", start_day_of_week = 7) %>% 
  mutate(date = as.character(date)) %>%
  rename(Date = date) %>%
...
weekly_RC_Wells_toDec2021 %>% 
  readr::write_csv(path = "weekly_Wells_RC_Dec2021.csv")
