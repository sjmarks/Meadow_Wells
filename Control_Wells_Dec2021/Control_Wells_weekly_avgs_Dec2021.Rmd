---
title: "Control_Wells_weekly_avgs_Dec2021"
author: "Joe Murphy"
date: "02/04/2022"
...
## Latest Control Well Compilation Data (December 2021)

```{r}

Control_Wells_Dec2021 <- readr::read_csv("raw/compiledwells_Control_Dec2021.csv", 
...
Control_Wells_good_data_Dec2021 <- Control_Wells_Dec2021 %>%
...
weekly_Control_Wells_toDec2021 <- temp_agg_meadow_dat(Control_Wells_good_data_Dec2021, interval = "30 min", start_day_of_week = 7) %>% 
  mutate(date = as.character(date)) %>%
  dplyr::rename(Date = date) %>%
...
weekly_Control_Wells_toDec2021 %>% 
  readr::write_csv(path = "weekly_Wells_Control_Dec2021.csv")
