---
title: "Marian_Wells_weekly_avgs_dec2021"
author: "Joe Murphy"
date: "02/04/2021"
...
## Latest 30-minute Marian Well Compilation Data (December 2021)

```{r}

Marian_Wells_Dec2021 <- readr::read_csv("raw/compiledwells_Marian_Dec2021.csv", 
...
Marian_Wells_good_data_Dec2021 <- Marian_Wells_Dec2021 %>%
...
weekly_Marian_Wells_toDec2021 <- temp_agg_meadow_dat(Marian_Wells_good_data_Dec2021, interval = "30 min", start_day_of_week = 7) %>% 
  mutate(date = as.character(date)) %>%
  rename(Date = date) %>%
...
weekly_Marian_Wells_toDec2021 %>% 
  # Date variable is already recognized as a character variable
  readr::write_csv(path = "weekly_Wells_Marian_Dec2021.csv")
