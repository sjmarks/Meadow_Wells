---
title: "Marian_Wells_weekly_avgs_July2021"
author: "Simon Marks"
date: "7/21/2021"
...
## Latest 30-minute Marian Well Compilation Data (July 2021)

```{r}

Marian_Wells_July2021 <- readr::read_csv("Marian_Wells_July2021/raw/compiledwells_Marian_July2021.csv", 
...
Marian_Wells_good_data_July2021 <- Marian_Wells_July2021 %>%
...
weekly_Marian_Wells_toJuly2021 <- temp_agg_meadow_dat(Marian_Wells_good_data_July2021, interval = "30 min", start_day_of_week = 6) %>% 
  mutate(date = as.character(date)) %>%
  rename(Date = date) %>%
...
weekly_Marian_Wells_toJuly2021 %>% 
  # Date variable is already recognized as a character variable
  readr::write_csv(path = "Marian_Wells_July2021/weekly_Wells_Marian_July2021.csv")
